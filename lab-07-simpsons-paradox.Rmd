...
***There are `r ncol(Whickham)` Variables in the dataset. Both `outcome` and `smoker` are character data that are 2 level factors and `age` is a numerical data.***

```{r}
ggplot(data=Whickham, aes(y=outcome, fill = outcome)) +
  geom_bar() +
  ggtitle("Disribution of Outcome")
...
***This does not meet what I thought would happen. It appears that those who smoke have a higher probability of being alive 20 years later.***
